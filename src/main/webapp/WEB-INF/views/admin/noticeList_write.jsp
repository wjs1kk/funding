							...
							<div class="col-xxl">
								<div class="card mb-4">
									...
									<!-- 2023-05-31 박경은 - enctype="multipart/form-data" 추가 -->
										<form action="noticeListWritePro" name="noticeList" method="post" enctype="multipart/form-data">
											<input type="hidden" name="board_idx" id="board_idx"
												value="${param.board_idx }"> <input type="hidden"
												name="pageNum" id="pageNum" value="${param.pageNum }">
											<div class="row mb-3">
