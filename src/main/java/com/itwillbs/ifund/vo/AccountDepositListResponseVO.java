...
public class AccountDepositListResponseVO {
	...
	public List<AccountDepositResponseVO> getRes_list() {
		return res_list;
	}
	public void setRes_list(List<AccountDepositResponseVO> res_list) {
		this.res_list = res_list;
	}
	@Override
	public String toString() {
		return "AccountDepositListResponseVO [api_tran_id=" + api_tran_id + ", api_tran_dtm=" + api_tran_dtm
				+ ", rsp_code=" + rsp_code + ", rsp_message=" + rsp_message + ", wd_bank_code_std=" + wd_bank_code_std
