	...
	<div class="web-header-large">
		<header class="header-wrapper">
			<div class="header-container">
				...
				<!-- top.jsp 왼쪽 와디즈 로고 -->
				<h1 class="wadiz-logo">
					<a href='${pageContext.request.contextPath }/'><span class="label">와디즈</span> <svg
				...
				<ul class="GNBDesktop_container__3X3Cg">
					<li class="GNBDesktop_item__H8bay"><a
						class="GNBDesktop_link__1AP6q" href="${pageContext.request.contextPath }/comingsoon"><span>오픈예정</span></a></li>
					<li class="GNBDesktop_item__H8bay"><a
						class="GNBDesktop_link__1AP6q" href="${pageContext.request.contextPath }/funding"><span>펀딩
								+</span></a></li>
					<li class="GNBDesktop_item__H8bay"><a
						class="GNBDesktop_link__1AP6q" href="${pageContext.request.contextPath }/preorder"><span>공동구매</span></a></li>
					<li class="GNBDesktop_item__H8bay"><a
						class="GNBDesktop_link__1AP6q" href="${pageContext.request.contextPath }/notice"><span>공지사항</span></a></li>
				...
				<div class="web-header-utils">
					...
					<c:choose>
						...
						<c:otherwise>
							<div class="HeaderDesktop_user__3zGmM" onclick="location.href='mypage/supporter'">
								<div class="User_container__bqVd2">
