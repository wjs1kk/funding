											...
											<button class="Button_button__3MO4n Button_secondary__2ECH- Button_md__3TvVa Button_startIcon__3w2N9 FollowingButton_followingButton__edQkd" type="button">
												<span>
													<svg viewBox="0 0 48 48" focusable="false" role="presentation"
														...
														<path d="M18 39.6L4.8 26.4l3.36-3.36L18 32.76l21.84-21.72 3.36 3.36z"></path></svg>
													<span class="Button_children__raEW4">팔로잉</span></span>
											</button>
										</div>
									</div>
									<div class="FollowingCard_divider__2NaPM"></div>
								</div>
							</div>
						</div>
					</div>
