...
<head>
	...
	<link rel="stylesheet" type="text/css" href="https://static.wadiz.kr/studio/funding/static/css/14.e4d2a6ed.chunk.css">
</head>
					...
					<section class="Page_container__1PffN">
						...
						<div class="Page_content__1d0Vb">
								...
								<div style="max-width: 630px;">
									...
									<div class="Section_content__3OkLZ">
										<div class="TextField_textField__23rCe TextField_md__2zsQn">
											...
											<em class="HelperMessage_helperMessage__1qZPy">40자 남음</em>
										</div>
									</div>
								</div>
							...
							<section class="Section_container__3md8M spacing-9"
								...
								<div class="Section_content__3OkLZ">
									<div class="spacing-5">
										<div class="ImageUploadField_container__2fG-h">
											첨부 파일을 업로드해 주세요.
											<div class="ImageUploadButton_container__2eGcY spacing-2">
												...
												<button
													...
													type="button">
													<span><span class="Button_children__q9VCZ">업로드</span></span>
												</button>
											</div>
										</div>
									</div>
							...
							<section class="Section_container__3md8M spacing-9"
								...
								<div class="Section_content__3OkLZ">
									<div>
										...
										<div color="danger"
											class="MessageBox_messageBox__3acWS MessageBox_danger__2ZmKO MessageBox_vertical__1mezf spacing-5">
											<span><svg viewBox="0 0 40 40" focusable="false"
													role="presentation"
													class="withIcon_icon__1Oal1 MessageBox_icon__31KWI MessageBox_withoutTitle__2S2r8"
													aria-hidden="true">
											...
											<div class="MessageBox_content__3db50">
												<div class="MessageBox_description__1bCQv">프로젝트 유형에 따라
													정산 절차가 달라요. 프로젝트 정보에서 프로젝트 유형을 선택해 주세요.</div>
											</div>
										</div>
										<div class="DateField_container__2FQ6X">
											<div class="ant-picker css-57nriz date-picker"
												...
												<div class="ant-picker-input">
													<input readonly="" placeholder="예시) 2023-05-14" title=""
														size="12" autocomplete="off" value=""><span
														class="ant-picker-suffix"><svg viewBox="0 0 32 32"
															focusable="false" role="presentation"
															class="withIcon_icon__3lrgp" aria-hidden="true">
															<path
																d="M24 4V1.6h-1.6V4H9.6V1.6H8V4H3.2v25.6h25.6V4zm3.2 24H4.8V5.6h22.4z"></path>
															<path
																d="M8 8.8h3.2V12H8zm6.4 3.2h3.2V8.8h-3.2zm6.4 0H24V8.8h-3.2zM8 18.4h3.2v-3.2H8zm6.4 0h3.2v-3.2h-3.2zm6.4 0H24v-3.2h-3.2zM8 24.8h3.2v-3.2H8zm6.4 0h3.2v-3.2h-3.2zm6.4 0H24v-3.2h-3.2z"></path></svg></span>
												</div>
											</div>
										</div>
									</div>
							...
							<section class="Section_container__3md8M spacing-9"
								...
								<div class="Section_header__1qwS7">
									<h2 class="Section_title__ikPIm Section_isOptional__DtcQ8">메이커
										프로모션 또는 파트너사</h2>
									<div class="Section_guide__2xeJO"></div>
								</div>
								<div class="Section_description__10Uwo">메이커 프로모션이나 파트너사를
									통해 프로젝트를 오픈할 때만 선택해 주세요.</div>
								<div class="Section_content__3OkLZ">
										...
										<div class=" css-2b097c-container">
											...
											<div class="select-menu__control css-1m205as-control">
												<div class="select-menu__value-container css-1hwfws3">
													<div
														class="select-menu__placeholder css-1wa3eu0-placeholder">선택해
														주세요</div>
													<input id="react-select-9-input" readonly="" tabindex="0"
							...
							<section class="Section_container__3md8M spacing-9"
								...
								<div class="Section_content__3OkLZ">
									<div class="CheckboxField_container__1FHmG">
										<label
											class="Checkbox_checkbox__27KzI Checkbox_md__28FjK Checkbox_labeled__uRUNZ"><input
							...
							<section class="Section_container__3md8M spacing-9"
								...
								<div class="Section_header__1qwS7" style="">
									...
									<div class="Section_guide__2xeJO">
										<div class="Section_helperMessage__3V6GQ">
											<a class="link"
												href="https://makercenter.wadiz.kr/board/card/231"
												target="_blank" rel="nofollow noopener noreferrer">더
								...
								<div class="Section_description__10Uwo">
									프로젝트가 더 잘 검색될 수 있도록 연관성이 높은 태그를 입력해 주세요.<br>예시) 캠핑의자 → 캠핑
								</div>
								<div class="Section_content__3OkLZ">
									<div class="TagField_container__3sRPU">
										<div
											class="TextField_textField__23rCe TextField_md__2zsQn TagField_textField__4XE6r">
											<label></label>
											<div class="TextField_field__1E9vt">
												<input placeholder="엔터를 누르면 최대 10개까지 태그를 입력할 수 있어요"
													maxlength="10" type="text"
													class="Input_input__2kAAL Input_md__3-eZ6"
													aria-invalid="false" value="">
											</div>
										</div>
										<div class="TagField_tagCountLabel__12Psm">0/10개의 태그</div>
										<div class="TagField_tagGroup__dZeSW"></div>
									</div>
								</div>
							</section>
							<button
