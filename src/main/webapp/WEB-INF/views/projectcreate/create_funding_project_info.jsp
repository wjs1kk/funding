...
<link rel="stylesheet" type="text/css" href="https://static.wadiz.kr/studio/funding/static/css/7.6e33e59e.chunk.css">
								...
								<section class="Section_container__3md8M spacing-9">
									<div style="max-width: 630px;">
										<div class="Section_header__1qwS7 spacing-4">
											<h2 class="Section_title__ikPIm Section_isRequired__F8rij">카테고리</h2>
										...
										<div class="Section_content__3OkLZ">
												...
												<div class=" css-2b097c-container" id="category">
													...
													<div class="select-menu__control css-1m205as-control">
														<div
															...
															<div
																class="select-menu__single-value css-1uccc91-singleValue">후원</div>
															<input id="react-select-4-input" readonly="" tabindex="0"
											...
											<div style="margin-top: 16px;">
												<div color="info"
													class="MessageBox_messageBox__3acWS MessageBox_info__16itf MessageBox_vertical__1mezf">
													...
													<div class="MessageBox_content__3db50">
														<div class="MessageBox_description__1bCQv">
															<ul>
																<li>사업자가 아닌 개인 메이커가 자아실현 또는 사회적 가치 창출 등을 위해 후원을 받을
																	목적인 경우에만 펀딩으로 진행할 수 있어요.</li>
																<li><strong>단, 프로젝트가 성공해도 프리오더(앵콜) 진행은
																		불가해요.</strong></li>
															</ul>
														</div>
													</div>
									...
									<div class="Section_guideMessage__3XqrM">
										<h4>어떤 서포터를 만나고 싶으세요?</h4>
										<p>프로젝트와 가장 잘 어울리는 카테고리를 선택해 주세요. 비슷한 관심사를 가진 서포터님들과 만날
											확률이 높아져요.</p>
										<p>예시) 반려동물 정수기: 테크·가전 or 반려동물 or 홈리빙</p>
									</div>
								</section>
								<section
										...
										<div class="Section_content__3OkLZ">
											<div class="Radios_box__3GDo6 spacing-5">
												<label for="FUNDING"
													...
													type="radio" id="FUNDING" value="FUNDING" checked=""><span
													...
													class="Radio_label__C-Uvs"><span
														...
														class="Radios_moreInfo__2mm0t"><a
															class="Radios_link__2Z-Gu"
															href="https://www.wadiz.kr/link/classification_guide_01"
															target="_blank" rel="noreferrer">펀딩 유형 자세히 보기</a></span></span></label><label
													for="PREORDER"
													class="Radio_radio__3reB4 Radio_lg__1w7t8 Radio_labeled__3Z_NE Radios_label__1Wcpl"><input
													type="radio" id="PREORDER" disabled="" value="PREORDER"><span
													class="Radio_icon__twaSu"></span><span
													class="Radio_label__C-Uvs"><span
														class="Radios_labelContent__3ueO3"><strong
															class="Radios_catogory__1-L3j">프리오더</strong>기존에 출시된
															제품·서비스·콘텐츠를 와디즈에서 특별한 혜택으로 공개해요.</span><span
														class="Radios_moreInfo__2mm0t"><a
															class="Radios_link__2Z-Gu"
															href="https://www.wadiz.kr/link/classification_guide_02"
															target="_blank" rel="noreferrer">프리오더 유형 자세히 보기</a></span></span></label><label
													for="GLOBAL"
													class="Radio_radio__3reB4 Radio_lg__1w7t8 Radio_labeled__3Z_NE Radios_label__1Wcpl"><input
													type="radio" id="GLOBAL" disabled="" value="GLOBAL"><span
													class="Radio_icon__twaSu"></span><span
													class="Radio_label__C-Uvs"><span
														class="Radios_labelContent__3ueO3"><strong
															class="Radios_catogory__1-L3j">프리오더-글로벌</strong>해외에서 출시된
															제품을 공식 유통해요.</span><span class="Radios_moreInfo__2mm0t"><a
															class="Radios_link__2Z-Gu"
															href="https://www.wadiz.kr/link/classification_guide_03"
															target="_blank" rel="noreferrer">프리오더-글로벌 유형 자세히 보기</a></span></span></label><label
													for="ENCORE"
													class="Radio_radio__3reB4 Radio_lg__1w7t8 Radio_labeled__3Z_NE Radios_label__1Wcpl"><input
													type="radio" id="ENCORE" disabled="" value="ENCORE"><span
													class="Radio_icon__twaSu"></span><span
													class="Radio_label__C-Uvs"><span
														class="Radios_labelContent__3ueO3"><strong
															class="Radios_catogory__1-L3j">프리오더-앵콜</strong>와디즈에서 성공한
															프로젝트를 다시 공개해요.</span><span class="Radios_moreInfo__2mm0t"><a
															class="Radios_link__2Z-Gu"
															href="https://www.wadiz.kr/link/classification_guide_04"
															target="_blank" rel="noreferrer">프리오더-앵콜 유형 자세히 보기</a></span></span></label>
											</div>
										</div>
									</div>
									<div class="Section_guideMessage__3XqrM">성공한 프로젝트의 리워드와
										새로운 리워드를 동시에 제공한다면 '와디즈에서 성공한 프로젝트를 다시 공개해요.'를 선택해 주세요.</div>
								</section>
								<div class="ClassificationField_container__3Jk9- spacing-9">
									<section
										class="Section_container__3md8M Field_makerTypeContainer__fmVot spacing-5">
										<div style="max-width: 630px;">
											<div class="Section_header__1qwS7 spacing-4">
												<h2 class="Section_title__ikPIm Section_isRequired__F8rij">메이커
													유형</h2>
												<div class="Section_guide__2xeJO"></div>
											</div>
											<div class="Section_content__3OkLZ">
												<div class="Field_desc__1EDAu" style="margin-bottom: 16px;">
													후원 카테고리는 개인으로만 진행 가능해요.<br>사업자인 경우 기부·캠페인으로 카테고리 변경 후
													진행해 주세요.
												</div>
												<div class="ToggleButton_flex__IlXuC">
													<button
														class="Button_button__1e2A2 Button_tertiaryGrey__3gRf4 Button_lg__3vRQD ToggleButton_box__3U0gi"
														type="button">
														<span><span class="Button_children__q9VCZ">개인</span></span>
													</button>
													<button
														class="Button_button__1e2A2 Button_tertiaryGrey__3gRf4 Button_lg__3vRQD Button_disabled__3x0Tg ToggleButton_box__3U0gi"
														type="button" disabled="">
														<span><span class="Button_children__q9VCZ">개인사업자</span></span>
													</button>
													<button
														class="Button_button__1e2A2 Button_tertiaryGrey__3gRf4 Button_lg__3vRQD Button_disabled__3x0Tg ToggleButton_box__3U0gi"
														type="button" disabled="">
														<span><span class="Button_children__q9VCZ">법인사업자</span></span>
													</button>
												</div>
											</div>
										</div>
										<div class="Section_guideMessage__3XqrM">
											<h4>사업자 등록증 상단의 사업자 종류를 확인해 주세요.</h4>
											<p>일반 과세자 간이 과세자는 개인 사업자를 선택해 주세요.</p>
											<p>프로젝트 유형에 따라 진행할 수 있는 메이커 유형이 달라요.</p>
											<a class="link" href="https://www.wadiz.kr/link/maker_guide"
												target="_blank" rel="noreferrer"><strong>메이커 유형
													조건 알아보기</strong></a>
										</div>
									</section>
								</div>
