									...
									<div>
										<div class="HeaderLayout_container__3fXkO">
											<div class="HeaderLayout_contents__F4hlC">
												<h2 class="ProjectTypeFormContainer_title__3Zn37">수수료∙정산
													관리</h2>
											</div>
										</div>
										<br> <br>
														...
														<div
															...
															<div class="TextField_field__1E9vt">
																<input maxlength="64" type="text" id="project_num"
																	value="${param.project_idx }" readonly="readonly"
																	class="Input_input__2kAAL Input_md__3-eZ6"
																	aria-invalid="false" style="width: 50%">
															</div>
														</div>
													</div>
												</div>
													...
													<div class="MakerInfoInputField_container__4b8t-">
														<div
															...
															<label><div>
																	<div class="ToolTipMobile_toolTipContainer__2tYPd">
																		<span
																			class="ToolTipMobile_label__1dBSo ToolTipMobile_required__3WiIn">지급요청
																			금액</span>
																	</div>
																</div></label> <span class="TextField_field__1E9vt"> <input
																maxlength="64" type="text" id="project_money"
																readonly="readonly"
																class="Input_input__2kAAL Input_md__3-eZ6"
																aria-invalid="false"
										...
										<div
											...
											<div class="ModalLayout_modalWrap__2TF56">
												...
												<path
													...
													<div>
														<h4>정산 지급금액(① - ②)</h4>
														<b style="color: red;" id="money"></b><b
															style="color: red;">원</b>
													...
													<div>
														...
														<p>
															포인트 & 쿠폰 결제분 <b id="point"></b>원 / 배송료 합계 <b
																id="delivery"></b>원 포함
														</p>
													</div>
													<hr>
													...
													<div>
														...
														<b id="planChargeMoney"></b><b>원</b> <span>(최종 결제완료
															금액 - 배송료 합계) X <span id="planCharge"></span>%
														</span> <br>
