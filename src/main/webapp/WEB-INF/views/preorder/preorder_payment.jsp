...
<body>
	...
	<!-- 										value="Y" autocomplete="off" onchange="eachTermsChanged()"> -->
										...
										<div id="personalInfoAgreementForThirdPartiesLypop"
											...
											<div class="agree-popup-body">
												<p>
													'공동구매하기・구매예약하기'를 통한 결제 및 리워드 전달 서비스를 제공하기 위해, 이용자의 사전 동의 아래
	...
	<!-- 										value="Y" autocomplete="off" onchange="eachTermsChanged()"> -->
										...
										<div id="AcceptanceOfLiabilityLypop" class="agree-popup"
											...
											<div class="agree-popup-body">
												<p>와디즈는 플랫폼을 제공하는 중개자로 공동구매하기・예약구매하기를 받는 당사자가 아닙니다. 보상품 제공
													등에 관한 지연, 제품의 하자 등으로 인한 일체의 법적책임은 공동구매하기・예약구매하기를 받는 프로젝트 개설자가
													...
													<ol>
														<li>본 장에서 사용하는 용어의 정의는 다음과 같습니다.
															<ol>
																...
																<li>"회원"이라 함은 본 약관에 동의하고 메이커, 판매자로부터 "재화 등"을 공동구매 또는
