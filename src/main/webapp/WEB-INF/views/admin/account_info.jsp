				...
				<div class="content-wrapper">
					...
					<div class="container-xxl flex-grow-1 container-p-y">
						<h4 class="fw-bold py-3 mb-4">
							<span class="text-muted fw-light">Tables /</span>공지사항
						</h4>
						<div class="card">
							<h5 class="card-header">Striped rows</h5>
							<!--                 <input type="button" value="계좌" id="btnAccountAuth" onclick="location.href='../bank_userInfo'"> -->
							<c:choose>
								<c:when test="${member.account_auth_status eq 'Y'}">
									<input type="button" value="계좌관리" id="btnAccountAuth"
										onclick="location.href='../bank_userInfo'">
								</c:when>
								<c:otherwise>
									<td class="td_right"><input type="button" value="인증하기"
										id="btnAccountAuth"> (계좌 인증 과정이 필요합니다.)</td>
								</c:otherwise>
							</c:choose>
	...
	$(function() {
		$("#btnAccountAuth")
				.on(
						"click",
						function() {
							let authWindow = window.open("about:blank",
									"authWindow", "width=500, height=700");
