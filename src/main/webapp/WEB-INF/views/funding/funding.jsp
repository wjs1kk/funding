			...
			<div class="MainWrapper_content__GZkTa">
					...
					<div class="TabsMobile_tabRoot__1KBCT">
						<div class="TabsMobile_tabsWrapper__3zP94">
							<ul
								...
								<li data-index="2"><button class="ImageTab_tab__3siCY">
										<div class="ImageTab_thumbnailContainer__3Polb">
											<div class="ImageTab_thumbnailPlaceholder__3mluI">
												<div class="ImageTab_thumbnail__3mZWA"
										...
										<div class="ImageTab_labelContainer__2apP3">
											<span class="ImageTab_label__SvWW9">테크·가전</span>
										</div>
									</button></li>
								<li data-index="3"><button class="ImageTab_tab__3siCY">
										<div class="ImageTab_thumbnailContainer__3Polb">
											<div class="ImageTab_thumbnailPlaceholder__3mluI">
												<div class="ImageTab_thumbnail__3mZWA"
										...
										<div class="ImageTab_labelContainer__2apP3">
											<span class="ImageTab_label__SvWW9">패션·잡화</span>
										</div>
									</button></li>
								<li data-index="4"><button class="ImageTab_tab__3siCY">
										<div class="ImageTab_thumbnailContainer__3Polb">
											<div class="ImageTab_thumbnailPlaceholder__3mluI">
												<div class="ImageTab_thumbnail__3mZWA"
										...
										<div class="ImageTab_labelContainer__2apP3">
											<span class="ImageTab_label__SvWW9">홈·리빙</span>
										</div>
									</button></li>
								<li data-index="5"><button class="ImageTab_tab__3siCY">
										<div class="ImageTab_thumbnailContainer__3Polb">
											<div class="ImageTab_thumbnailPlaceholder__3mluI">
												<div class="ImageTab_thumbnail__3mZWA"
										...
										<div class="ImageTab_labelContainer__2apP3">
											<span class="ImageTab_label__SvWW9">뷰티</span>
										</div>
									</button></li>
								<li data-index="6"><button class="ImageTab_tab__3siCY">
										<div class="ImageTab_thumbnailContainer__3Polb">
											<div class="ImageTab_thumbnailPlaceholder__3mluI">
												<div class="ImageTab_thumbnail__3mZWA"
										...
										<div class="ImageTab_labelContainer__2apP3">
											<span class="ImageTab_label__SvWW9">푸드</span>
										</div>
									</button></li>
								<li data-index="7"><button class="ImageTab_tab__3siCY">
										<div class="ImageTab_thumbnailContainer__3Polb">
											<div class="ImageTab_thumbnailPlaceholder__3mluI">
												<div class="ImageTab_thumbnail__3mZWA"
										...
										<div class="ImageTab_labelContainer__2apP3">
											<span class="ImageTab_label__SvWW9">출판</span>
										</div>
									</button></li>
								<li data-index="8"><button class="ImageTab_tab__3siCY">
										<div class="ImageTab_thumbnailContainer__3Polb">
											<div class="ImageTab_thumbnailPlaceholder__3mluI">
												<div class="ImageTab_thumbnail__3mZWA"
										...
										<div class="ImageTab_labelContainer__2apP3">
											<span class="ImageTab_label__SvWW9">클래스·컨설팅</span>
										</div>
									</button></li>
								<li data-index="9"><button class="ImageTab_tab__3siCY">
										<div class="ImageTab_thumbnailContainer__3Polb">
											<div class="ImageTab_thumbnailPlaceholder__3mluI">
												<div class="ImageTab_thumbnail__3mZWA"
										...
										<div class="ImageTab_labelContainer__2apP3">
											<span class="ImageTab_label__SvWW9">레저·아웃도어</span>
										</div>
									</button></li>
								<li data-index="10"><button class="ImageTab_tab__3siCY">
										<div class="ImageTab_thumbnailContainer__3Polb">
											<div class="ImageTab_thumbnailPlaceholder__3mluI">
												<div class="ImageTab_thumbnail__3mZWA"
										...
										<div class="ImageTab_labelContainer__2apP3">
											<span class="ImageTab_label__SvWW9">스포츠·모빌리티</span>
										</div>
									</button></li>
								<li data-index="11"><button class="ImageTab_tab__3siCY">
										<div class="ImageTab_thumbnailContainer__3Polb">
											<div class="ImageTab_thumbnailPlaceholder__3mluI">
												<div class="ImageTab_thumbnail__3mZWA"
										...
										<div class="ImageTab_labelContainer__2apP3">
											<span class="ImageTab_label__SvWW9">컬쳐·아티스트</span>
										</div>
									</button></li>
								<li data-index="12"><button class="ImageTab_tab__3siCY">
										<div class="ImageTab_thumbnailContainer__3Polb">
											<div class="ImageTab_thumbnailPlaceholder__3mluI">
												<div class="ImageTab_thumbnail__3mZWA"
										...
										<div class="ImageTab_labelContainer__2apP3">
											<span class="ImageTab_label__SvWW9">캐릭터·굿즈</span>
										</div>
									</button></li>
								<li data-index="13"><button class="ImageTab_tab__3siCY">
										<div class="ImageTab_thumbnailContainer__3Polb">
											<div class="ImageTab_thumbnailPlaceholder__3mluI">
												<div class="ImageTab_thumbnail__3mZWA"
										...
										<div class="ImageTab_labelContainer__2apP3">
											<span class="ImageTab_label__SvWW9">반려동물</span>
										</div>
									</button></li>
								<li data-index="14"><button class="ImageTab_tab__3siCY">
										<div class="ImageTab_thumbnailContainer__3Polb">
											<div class="ImageTab_thumbnailPlaceholder__3mluI">
												<div class="ImageTab_thumbnail__3mZWA"
										...
										<div class="ImageTab_labelContainer__2apP3">
											<span class="ImageTab_label__SvWW9">베이비·키즈</span>
										</div>
									</button></li>
								<li data-index="15"><button class="ImageTab_tab__3siCY">
										<div class="ImageTab_thumbnailContainer__3Polb">
											<div class="ImageTab_thumbnailPlaceholder__3mluI">
												<div class="ImageTab_thumbnail__3mZWA"
													style="background-image: url(&quot;https://cdn3.wadiz.kr/category/icon/category_game.png&quot;);"></div>
											</div>
										</div>
										<div class="ImageTab_labelContainer__2apP3">
											<span class="ImageTab_label__SvWW9">게임·취미</span>
										</div>
									</button></li>
								<li data-index="16"><button class="ImageTab_tab__3siCY">
										<div class="ImageTab_thumbnailContainer__3Polb">
											<div class="ImageTab_thumbnailPlaceholder__3mluI">
												<div class="ImageTab_thumbnail__3mZWA"
													style="background-image: url(&quot;https://cdn3.wadiz.kr/category/icon/category_travel.png&quot;);"></div>
											</div>
										</div>
										<div class="ImageTab_labelContainer__2apP3">
											<span class="ImageTab_label__SvWW9">여행·숙박</span>
										</div>
									</button></li>
								<li data-index="17"><button class="ImageTab_tab__3siCY">
										<div class="ImageTab_thumbnailContainer__3Polb">
											<div class="ImageTab_thumbnailPlaceholder__3mluI">
												<div class="ImageTab_thumbnail__3mZWA"
													style="background-image: url(&quot;https://cdn3.wadiz.kr/category/icon/category_campaign.png&quot;);"></div>
											</div>
										</div>
										<div class="ImageTab_labelContainer__2apP3">
											<span class="ImageTab_label__SvWW9">기부∙캠페인</span>
										</div>
									</button></li>
								<li data-index="18"><button class="ImageTab_tab__3siCY">
										<div class="ImageTab_thumbnailContainer__3Polb">
											<div class="ImageTab_thumbnailPlaceholder__3mluI">
												<div class="ImageTab_thumbnail__3mZWA"
													style="background-image: url(&quot;https://cdn3.wadiz.kr/category/icon/category_donation.png&quot;);"></div>
											</div>
										</div>
										<div class="ImageTab_labelContainer__2apP3">
											<span class="ImageTab_label__SvWW9">후원</span>
										</div>
									</button></li>
								<li data-index="19"><button class="ImageTab_tab__3siCY">
										<div class="ImageTab_thumbnailContainer__3Polb">
											<div class="ImageTab_thumbnailPlaceholder__3mluI">
												<div class="ImageTab_thumbnail__3mZWA"
													style="background-image: url(&quot;https://cdn3.wadiz.kr/category/icon/category_community.png&quot;);"></div>
											</div>
										</div>
										<div class="ImageTab_labelContainer__2apP3">
											<span class="ImageTab_label__SvWW9">모임</span>
										</div>
									</button></li>
							</ul>
				...
				<div class="Main_container__2oIVn">
					<div class="Main_category__3sabq">
						<p class="Main_categoryName__3YilF">전체</p>
						<div class="Main_filterWrap__2l__0">
							...
							<ul class="OrderSelectDesktop_sortContainer__1YLsr">
								<li
									class="OrderSelectDesktop_sortItem__12TKi OrderSelectDesktop_active__YTP2K">추천순</li>
								<li class="OrderSelectDesktop_sortItem__12TKi">인기순</li>
								<li class="OrderSelectDesktop_sortItem__12TKi">모집금액순</li>
								<li class="OrderSelectDesktop_sortItem__12TKi">마감임박순</li>
								<li class="OrderSelectDesktop_sortItem__12TKi">최신순</li>
								<li class="OrderSelectDesktop_sortItem__12TKi">응원참여자순</li>
							</ul>
						</div>
					</div>
...
<!-- 										광고유무 표시 -->
									<c:if test="${projectDetailList.project_plan eq '2' or projectDetailList.project_plan eq '3' }">
										<div class="PreorderMainCard_ad__2IzVz" style="color:black">AD</div>
									</c:if>
								...
								<div class="PreorderMainCard_contentContainer__1OmhF">
									<div class="PreorderMainCard_header__R39X1">
										<div class="PreorderMainCard_headerLeft__2nwa1">
											...
											<fmt:formatNumber value="${(projectDetailList.project_detail_amount/projectDetailList.project_target)}" type="percent"/>
											달성</p>
											<p class="PreorderMainCard_amount__3UOXm"><fmt:formatNumber value="${projectDetailList.project_detail_amount }"/>원</p>
										</div>
